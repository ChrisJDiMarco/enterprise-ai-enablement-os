...
export function MiniMetric({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-lg border border-[var(--border)]/72 bg-[var(--surface)] px-3 py-2.5 shadow-[var(--shadow-button)]">
