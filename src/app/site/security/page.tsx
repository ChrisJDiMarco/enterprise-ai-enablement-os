  ...
  return (
    <main>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-5 py-16 sm:px-6 lg:grid-cols-[1fr_460px] lg:px-8 lg:py-20">
          <div>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link href="/site/collateral" className="inline-flex h-11 items-center justify-center gap-2 rounded-lg bg-[var(--primary)] px-5 text-sm font-semibold text-white shadow-sm">
                Download security brief
                <ArrowRight size={16} />
              </Link>
              <Link href="/" className="inline-flex h-11 items-center justify-center rounded-lg border border-slate-200 bg-white px-5 text-sm font-semibold text-slate-700">
                Open readiness gate
              </Link>
            </div>
          </div>
          <div className="rounded-lg border border-slate-200 bg-slate-950 p-6 text-white shadow-[var(--shadow-elevated)]">
      ...
      >
        <div className="grid gap-3 md:grid-cols-2">
          {securityControls.map((control) => (
            <div key={control} className="flex items-start gap-3 rounded-lg border border-slate-200 bg-white p-4 shadow-[var(--shadow-card)]">
              <span className="mt-0.5 flex size-7 shrink-0 items-center justify-center rounded-lg bg-green-50 text-green-700">
                <ShieldCheck size={15} />
              </span>
              <span className="text-sm leading-6 text-slate-700">{control}</span>
            </div>
          ))}
        </div>
      </SiteSection>
      ...
      >
        <div className="grid gap-4 lg:grid-cols-4">
          {[
            ...
            <article key={title} className="rounded-lg border border-slate-200 bg-white p-5 shadow-[var(--shadow-card)]">
      ...
      <section className="mx-auto max-w-7xl px-5 py-8 sm:px-6 lg:px-8">
        <div className="rounded-lg border border-slate-200 bg-white p-6 shadow-[var(--shadow-card)]">
