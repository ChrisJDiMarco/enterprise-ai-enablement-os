...
export const vendorRiskRecords: VendorRiskRecord[] = [
  {
    ...
    examples: "OpenAI, Anthropic, Google, Azure-hosted model endpoints",
  ...
  },
  {
    ...
    examples: "Microsoft 365 Copilot, Salesforce Einstein, ServiceNow AI Agents",
  ...
  },
  {
    ...
    examples: "Glean, vector databases, enterprise search, knowledge graph systems",
  ...
  },
  {
    ...
    examples: "Workato, Power Automate, Zapier Enterprise, UiPath, persistent workers",
